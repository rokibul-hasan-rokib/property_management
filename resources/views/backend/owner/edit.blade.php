                    ...
                    <div class="card-body">
                     ...
                     <form action="{{ route('owners.update', $owner->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" placeholder="Enter Description">{{ old('description', $owner->description) }}</textarea>
                            </div>
                            ...
                            <div class="form-group mb-2">
                                ...
                                @if($owner->image)
                                    <div class="mt-2">
                                        <img src="{{ asset('storage/' . $owner->image) }}" alt="{{ $owner->name }}" width="150" class="img-thumbnail">
                                    </div>
                                    <small>Current image: {{ $owner->image }}</small>
                                @endif
                            </div>
