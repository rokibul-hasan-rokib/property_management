            ...
            <form method="POST" action="{{ route('register.store') }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="employment_status" name="employment_status"
                        placeholder="Your job title or employment status">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="monthly_income" name="monthly_income"
                        placeholder="Enter your monthly income" step="0.01">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="rental_budget" name="rental_budget"
                        placeholder="Enter your rental budget" step="0.01">
